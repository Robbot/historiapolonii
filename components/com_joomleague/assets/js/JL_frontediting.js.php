...
if (document.getElementById(containerid).style.display=='none') {
	...
	var url="<?php echo 'index2.php?option=com_joomleague&controller=editmatch&task=load&p='.$joomleague->id.'&mid=';?>"+matchid;
	...
	var url="<?php echo 'index2.php?option=com_joomleague&controller=editmatch&task=cancel&p='.$joomleague->id."&mid=";?>"+matchid;
	var answer = confirm ("<?php echo JText::_('JL_EDIT_FORM_RESULTS_CONFIRM');?>")
	if (answer) {
