...
class JoomleagueViewResultsmatrix extends JoomleagueViewResults  {
	...
	function display($tpl = null)
	{
		...
		$this->assignRef('currenturl', 		JoomleagueHelperRoute::getResultsMatrixRoute($resultsmodel->getProject()->slug, $this->roundid, $resultsmodel->divisionid));
	...
	function getRoundSelectNavigation(&$rounds, $division=0)
	{
		...
		foreach ($rounds as $r)
		{
			$link = JoomleagueHelperRoute::getResultsMatrixRoute($this->project->slug, $r->value, $division);
