		...
		<thead>
			<tr class="sectiontableheader rosterheader">
				<th width="60%" colspan="<?php echo $positionHeaderSpan; ?>">
					<?php echo JText::_("JL_ROSTER_STAFF").'&nbsp;'; ?>
				</th>
				<?php
				...
				<th><?php echo JText::_('JL_ROSTER_STAFF_FUNCTION'); ?></th>
			</tr>
		</thead>
		<?php
			$k=0;
			...
			<tr class="<?php echo ($k==0)? $this->config['style_class1'] : $this->config['style_class2']; ?>">
				...
				switch ($this->config['staff_position_format'])
				{
					case 2:	 // show member with text
								$staff_position = JText::sprintf('JL_ROSTER_MEMBER_OF',JText::_($row->parentname));
								break;

					case 3:	 // show function with text
								$staff_position .= JText::sprintf('JL_ROSTER_FUNCTION_IS',JText::_($row->position));
								break;
