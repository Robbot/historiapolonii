...
<h2><?php	echo JText::_('JL_PERSON_PERSONAL_STATISTICS');	?></h2>
	...
	<tr>
		...
		<table id="playercareer">
			...
			<tr class="sectiontableheader">
				<th class="td_l" nowrap="nowrap"><?php echo JText::_('JL_PERSON_COMPETITION'); ?></th>
				<th class="td_l" nowrap="nowrap"><?php echo JText::_('JL_PERSON_TEAM'); ?></th>
				<th class="td_c"><?php
				$imageTitle=JText::_('JL_PERSON_PLAYED');
				...
				if (!strpos(" ".$iconPath,"/")){$iconPath="media/com_joomleague/event_icons/".$iconPath;}
			...
			<tr class="career_stats_total">
				<td class="td_r" colspan="2"><b><?php echo JText::_('JL_PERSON_CAREER_TOTAL'); ?></b></td>
