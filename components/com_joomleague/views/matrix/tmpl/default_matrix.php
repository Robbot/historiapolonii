			...
			foreach ($this->results as $result) {
				if (($result->projectteam1_id == $team_row->projectteamid) && ($result->projectteam2_id == $team_col->projectteamid)) {
					...
					if ($result->decision == 0) {
						...
						if($e1 > $e2) {
							$e1 = '<span style="font-weight: bold; color:'.$this->config['color_win'].'">'.$e1.'</span>';
							$e2 = '<span style="font-weight: bold; color:'.$this->config['color_win'].'">'.$e2.'</span>';
						} else if ($e1 == $e2) {
							$e1 = '<span style="font-weight: bold; color:'.$this->config['color_draw'].'">'.$e1.'</span>';
							$e2 = '<span style="font-weight: bold; color:'.$this->config['color_draw'].'">'.$e2.'</span>';
						} else if ($e1 < $e2) {
							$e1 = '<span style="font-weight: bold; color:'.$this->config['color_loss'].'">'.$e1.'</span>';
							$e2 = '<span style="font-weight: bold; color:'.$this->config['color_loss'].'">'.$e2.'</span>';
						}
