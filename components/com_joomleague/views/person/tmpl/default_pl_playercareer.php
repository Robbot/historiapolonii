				...
				<tr class="sectiontableheader">
					...
					<th class="td_c">
						...
						echo JHTML::image( 'media/com_joomleague/event_icons/played.png',
											 JText::_( 'JL_PLAYER_PLAYED' ),
											 array( ' title' => JText::_( 'JL_PLAYER_PLAYED' ),
													' width' => 20,
													' height' => 20 ) );
						?>
					</th>
						 ...
						 ( $this->overallconfig['use_jl_substitution'] == 1 ) )
					{
						...
						<th class="td_c">
							...
							echo JHTML::image( 'media/com_joomleague/event_icons/startroster.png',
												 JText::_( 'JL_PLAYER_STARTROSTER' ),
												 array( ' title' => JText::_( 'JL_PLAYER_STARTROSTER' ) ) );
							?>
						</th>
						<th class="td_c">
							<?php
							echo JHTML::image( 'media/com_joomleague/event_icons/in.png',
												 JText::_( 'JL_PLAYER_IN' ),
												 array( ' title' => JText::_( 'JL_PLAYER_IN' ) ) );
							?>
						</th>
						<th class="td_c">
							<?php
							echo JHTML::image( 'media/com_joomleague/event_icons/out.png',
												 JText::_( 'JL_PLAYER_OUT' ),
												 array( ' title' => JText::_( 'JL_PLAYER_OUT' ) ) );
							?>
						</th>
						<?php
					}
