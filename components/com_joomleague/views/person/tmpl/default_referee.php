		...
		<tr>
			...
			if ( $this->config['show_referee_photo'] == 1 )
			{
				...
				<td width="50%" align="center" valign="middle">
					<?php
					$imgTitle = JText::_( "JL_REFEREE_PICTURE" ) . " " . $this->referee->firstname . ' ' . $this->referee->lastname;
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="40%" align="right">
							<b>
								<?php
								echo JText::_( 'JL_REFEREE_NAME');
								?>
							</b>
						</td>
						<td width="60%" class="td_l">
							<?php
							$dummy = str_replace( "%FIRSTNAME%", $this->referee->firstname, JText::_( 'JL_REFEREE_NAME_FORM' ) );
