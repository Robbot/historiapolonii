	...
	<table width="96%" align="center" border="0" cellpadding="0" cellspacing="5">
		...
		if ($this->inprojectinfo->injury > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$injury_date = JHTML::date($this->roundsdata[$this->inprojectinfo->injury_date]['date_first'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$injury_date .= " - ".$this->inprojectinfo->injury_date.". ".JText::_('JL_MATCHDAY');
				}

				//injury end
				if (array_key_exists($this->inprojectinfo->injury_end, $this->roundsdata))
				{
					$injury_end = JHTML::date($this->roundsdata[$this->inprojectinfo->injury_end]['date_last'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$injury_end .= " - ".$this->inprojectinfo->injury_end.". ".JText::_('JL_MATCHDAY');
				}
			}
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							...
							echo JText::_( 'JL_PLAYER_INJURED' );
							?>
						</b>
					</td>
					<td class="td_l">
			...
			else
			{
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_INJURY_DATE' );
							?>
						</b>
					</td>
					<td class="td_l">
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_INJURY_END' );
							?>
						</b>
					</td>
					<td class="td_l">
			...
			<tr>
				<td class="td_l" nowrap="nowrap">
					<b>
						<?php
						echo JText::_( 'JL_PLAYER_INJURY_TYPE' );
						?>
					</b>
				</td>
				<td class="td_l">
		...
		if ($this->inprojectinfo->suspension > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$suspension_date = JHTML::date($this->roundsdata[$this->inprojectinfo->suspension_date]['date_first'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$suspension_date .= " - ".$this->inprojectinfo->suspension_date.". ".JText::_('JL_MATCHDAY');
				}

				//suspension end
				if (array_key_exists($this->inprojectinfo->suspension_end, $this->roundsdata))
				{
					$suspension_end = JHTML::date($this->roundsdata[$this->inprojectinfo->suspension_end]['date_last'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$suspension_end .= " - ".$this->inprojectinfo->suspension_end.". ".JText::_('JL_MATCHDAY');
				}
			}
					...
					<td class="td_l" style="color: red">
						<b>
							...
							echo "&nbsp;&nbsp;" . JHTML::image(	'media/com_joomleague/event_icons/suspension.gif',
																$imageTitle,
																array( 'title' => $imageTitle ) );
							echo JText::_( 'JL_PLAYER_SUSPENDED' );
							?>
						</b>
					</td>
					<td class="td_l">
			...
			else
			{
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_SUSPENSION_DATE' );
							?>
						</b>
					</td>
					<td class="td_l">
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_SUSPENSION_END' );
							?>
						</b>
					</td>
					<td class="td_l">
			...
			<tr>
				<td class="td_l" nowrap="nowrap">
					<b>
						<?php
						echo JText::_( 'JL_PLAYER_SUSPENSION_REASON' );
						?>
					</b>
				</td>
				<td class="td_l">
		...
		if ($this->inprojectinfo->away > 0)
		{
			...
			if (is_array($this->roundsdata))
			{
				...
				{
					$away_date = JHTML::date($this->roundsdata[$this->inprojectinfo->away_date]['date_first'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$away_date .= " - ".$this->inprojectinfo->away_date.". ".JText::_('JL_MATCHDAY');
				}

				//suspension end
				if (array_key_exists($this->inprojectinfo->away_end, $this->roundsdata))
				{
					$away_end = JHTML::date($this->roundsdata[$this->inprojectinfo->away_end]['date_last'], JText::_('JL_BASIC_CALENDAR_DATE'));
					$away_end .= " - ".$this->inprojectinfo->away_end.". ".JText::_('JL_MATCHDAY');
				}
			}
			...
			else
			{
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_AWAY_DATE' );
							?>
						</b>
					</td>
					<td class="td_l">
				...
				<tr>
					<td class="td_l" style="color: red">
						<b>
							<?php
							echo JText::_( 'JL_PLAYER_AWAY_END' );
							?>
						</b>
					</td>
					<td class="td_l">
			...
			<tr>
				<td class="td_l" nowrap="nowrap">
					<b>
						<?php
						echo JText::_( 'JL_PLAYER_AWAY_REASON' );
						?>
					</b>
				</td>
				<td class="td_l">
