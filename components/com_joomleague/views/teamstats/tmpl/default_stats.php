		...
		<table cellspacing="0" border="0" width="100%">
			<thead>
				<tr class="sectiontableheader">
					<th>&nbsp;</th>
					<th align="right" width="20%"><?php echo JText::_('JL_TEAMSTATS_TOTAL'); ?></th>
					<?php if ( $this->config['home_away_stats'] ): ?>
					<th align="right" width="20%"><?php echo JText::_('JL_TEAMSTATS_HOME'); ?></th>
					<th align="right" width="20%"><?php echo JText::_('JL_TEAMSTATS_AWAY'); ?></th>
					<?php endif; ?>
				</tr>
			</thead>
			<tbody>
			...
			?>
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_MATCHES_OVERALL'); ?>:</td>
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_MATCHES_PLAYED'); ?>:</td>
				...
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_WIN'); ?>:</td>
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_DRAW'); ?>:</td>
				...
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_LOST'); ?>:</td>
				...
				<?php if (count($this->results['forfeit'])): ?>
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_FORFEIT'); ?>:</td>
				...
				<?php if ( $this->config['home_away_stats'] ): ?>
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_MATCHES_HIGHEST_WIN'); ?>:</td>
					<td class="statvalue">
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_MATCHES_HIGHEST_LOSS'); ?>:</td>
					<td class="statvalue">
				...
				?>
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_TOTAL'); ?>:</td>
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_TOTAL_PER_MATCH'); ?>:</td>
				...
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_FOR'); ?></td>
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_FOR_PER_MATCH');?>:</td>
				...
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_AGAINST'); ?></td>
				...
				<tr class="sectiontableentry2">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_GOALS_AGAINST_PER_MATCH'); ?>:</td>
				...
				<tr class="sectiontableentry1">
					<td class="statlabel"><?php echo JText::_('JL_TEAMSTATS_NO_GOALS_AGAINST'); ?></td>
