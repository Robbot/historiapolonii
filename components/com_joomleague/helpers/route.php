...
class JoomleagueHelperRoute
{
	...
	function getResultsRankingRoute( $projectid, $round=0, $division=0 )
	{
		$params = array(	"option" => "com_joomleague",
					"view" => "resultsranking",
					"p" => $projectid );
	...
	function getResultsMatrixRoute( $projectid, $round=0, $division=0 )
	{
		$params = array(	"option" => "com_joomleague",
					"view" => "resultsmatrix",
					"p" => $projectid );
	...
	function getRankingMatrixRoute( $projectid, $round=0, $division=0 )
	{
		$params = array(	"option" => "com_joomleague",
					"view" => "rankingmatrix",
					"p" => $projectid );
