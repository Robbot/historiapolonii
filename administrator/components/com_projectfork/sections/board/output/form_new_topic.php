<?php
/**
* $Id: form_new_topic.php 837 2010-11-17 12:03:35Z eaxs $
* @package    Projectfork
* @subpackage Board
...
<div class="pf_container">
    <div class="pf_header componentheading">
        <h3><?php echo $ws_title." / "; echo PFformat::Lang('BOARD')." :: ".PFformat::Lang('NEW_TOPIC');?></h3>
    </div>
    <div class="pf_body">
        <!-- NAVIGATION START-->
