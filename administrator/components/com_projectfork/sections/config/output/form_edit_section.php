<?php
/**
* $Id: form_edit_section.php 837 2010-11-17 12:03:35Z eaxs $
* @package    Projectfork
* @subpackage Config
...
<div class="pf_container">
    <div class="pf_header componentheading">
        <h1><?php echo PFformat::Lang('CONFIG');?> :: <?php echo PFformat::Lang('SECTIONS');?>:: <?php echo PFformat::Lang('EDIT');?></h1>
    </div>
    <div class="pf_body">
...
<table class="admintable">
    ...
    <tr>
        <td class="key" width="150"><?php echo PFformat::Lang('SPECIAL_CONDITION');?></td>
        <td><?php echo PFconfigHelper::SelectSpecialCondition('tags', $row->tags); ?></td>
    </tr>
    <tr>
...
<?php echo PFconfigHelper::HTMLsectionPermissions($row->name);?>
...
echo $form->HiddenField("rts");
echo $form->HiddenField("apply");
echo $form->End();
?>
<script type="text/javascript">
function task_update_section(apv)
{
	document.adminForm.apply.value = apv;
	submitbutton('task_update_section');
}
</script>