...
class JoomleagueViewMatches extends JLGView
{
	...
	function _displayDefault($tpl)
	{
		...
		{
			$teams[]=JHTML::_('select.option','0',JText::_('JL_GLOBAL_SELECT_TEAM'));
			$divhomeid = 0;
		...
		$ress =& JoomleagueHelper::getRoundsOptions($project_id);
    ...
    if ( $ress =& JoomleagueHelper::getRoundsOptions($project_id) )
    {
		...
		$this->assignRef('prefill', $params->get('use_prefilled_match_roster'));
		$this->assignRef('show_roundlist_in_matches', $params->get('cfg_show_roundlist_in_matches_overview'));
