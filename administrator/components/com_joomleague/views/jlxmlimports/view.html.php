...
class JoomleagueViewJLXMLImports extends JLGView
{
	function display($tpl=null)
	{
		...
		JToolBarHelper::title(JText::_('JL_ADMIN_XML_IMPORT_TITLE_1_3'),'config');
...
public function dump_variable($name, $value)
{
	...
	private function _displayForm($tpl)
	{
		...
		$data			= $model->getData();
		$this->debug_info			= $model->getDebugInfo();
    ...
    $this->input_type = 'hidden';
		...
		// Set toolbar items for the page
		JToolBarHelper::title(JText::_('JL_ADMIN_XML_IMPORT_TITLE_2_3'),'generic.png');
