...
class XGalleryViewCollections extends JView {	
	function display($tpl = null) {
		...
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( $option.'.collections.filter_order_Dir',	'filter_order_Dir',	'', 'word' );
		...
		$category[] = JHTML::_('select.option',  '', JText::_( 'SELECT CATEGORY' ) );
		...
		*/
		...
		$lists['categories'] = & $this->get( 'CollCategories' );
