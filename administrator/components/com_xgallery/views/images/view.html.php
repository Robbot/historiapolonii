...
class MediaViewImages extends JView
{
	function display($tpl = null)
	{
		...
		JHTML::_('script'    , 'popup-imagemanager.js', $append .'components/com_xgallery/assets/');
		JHTML::_('stylesheet', 'popup-imagemanager.css', $append .'components/com_xgallery/assets/');
