...
var ImageManager = {
	...
	setFolder: function(folder, cont, id, rtype)
	{
		...
		this.frame.location.href='index.php?option=com_xgallery&'+cont+id+rtype+'&task=add&controller=folders&view=imagesList&tmpl=component&folder=' + folder;
	},
