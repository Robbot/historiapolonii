...
function uploadStart(file) {
	try {
		...
		feedback.innerHTML = this.getStats().files_queued + " Image(s) remaining. Please wait till uploading is complete...";
...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		progressCancel.href = "#";
		//progressCancel.onclick = function () { cancelQueue(); };
		progressCancel.style.visibility = "hidden";
		//progressCancel.setAttribute("id", "btnCancel");
		...
		//var count = this.getStats().files_queued;
		var progressFeedback = document.createElement("div");
		progressFeedback.className = "progressFeedback";
		progressFeedback.setAttribute("id", "progressFeedback");
		progressFeedback.appendChild(document.createTextNode("Please wait till uploading is complete..."));
		...
		this.fileProgressElement.appendChild(progressFeedback);
