				...
				<table class="eventsranking">
					<thead>
						<tr class="sectiontableheader">
							...
							<?php if ($showTeam == 1) : ?>
							<th class="team"><?php echo JText::_('MOD EVENT COL TEAM');?></th>
							<?php endif; ?>
							<th class="td_c">
...
<p class="fulltablelink"><?php echo JHTML::link(JoomleagueHelperRoute::getEventsRankingRoute($list['project']->slug, $params->get('divisionid',0) , $params->get('tid',0), $params->get('evid',0), $params->get('mid',0)), JText::_('VIEW FULL TABLE')); ?></p>
<?php endif; ?>
</div>
